...
public class EditarPerfilIncorrectoRealizaLoginAntes {
  ...
  @Test
  public void testEditarPerfilIncorrectoRealizaLoginAntes() throws Exception {
    ...
    driver.findElement(By.id("Email")).clear();
    driver.findElement(By.id("Email")).sendKeys("incorrecto");
    int numberRandom = (int) Math.floor(Math.random()*1500000);
    String s = "" + numberRandom;
    CharSequence x = s.toString();
    System.out.println(numberRandom);
    driver.findElement(By.id("PhoneNumber")).clear();
    driver.findElement(By.id("PhoneNumber")).sendKeys(x);
